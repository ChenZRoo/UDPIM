...
public class MediaWrapper {
	 ...
	 * @param listener 回调事件
	 */
	public void startPlay(String source, MediaPlay.OnPlayCallbackListener listener){
		if(mPlayer == null){
	 ...
	 */
	public void startRecord(MediaRecord.OnRecordErrorListener listener){
		if(mRecorder == null){
